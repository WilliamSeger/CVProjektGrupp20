...
namespace WebApplication1.Controllers
{
    ...
    public class ResumeController : Controller
    {
        ...
        public IActionResult Search()
		{
            ...
            {
                return View("Views/Error/ErrorView.cshtml", "No resumes could be found in the database");
            }
        }
		...
		public async Task<IActionResult> EditResume()
		{
            ...
            {
                return View("Views/Error/ErrorView.cshtml", "Resume could not be updated in the database");
            }
		...
		public IActionResult Delete(int id)
		{
			...
			{
                return View("Views/Error/ErrorView.cshtml", "Resume could not be removed from the database");
            }
        }
		[Authorize]
		[HttpPost]
		public IActionResult AddNew(Resume resume)
		{
            ...
            {
                return View("Views/Error/ErrorView.cshtml", "Resume could not be added to the database");
            }
		...
		{
			//Creates a new blank resume that is saved in the database and sends it to the view. Needs to be saved to the database
            //so that the inputfields can bind to the Resume object.
        ...
        public IActionResult addItem(int id, int caseId, string method, Resume resume)
		{
            ...
            {
                return View("Views/Error/ErrorView.cshtml", "Item could not be added to the Resume");
            }
        }
        [HttpPost]
        public IActionResult RemoveField(int caseId, int profId, string method, Resume resume)
        {
            ...
            {
                return View("Views/Error/ErrorView.cshtml", "Item could not be removed from the Resume");
            }
        }
    }
}
